...
function updateMenu(mode){
  ...
  let noProject = {"label":"Medable","submenu":[{"label":"Add Project...","command":"medable-dev-tools:addProject"}]},
      ...
      fullMenu = {"label":"Medable","submenu":[{"label":"Test","command":"medable-dev-tools:test"},{"label":"Pull All","command":"medable-dev-tools:pull"},{"label":"Pull All (Force)","command":"medable-dev-tools:forcePull"},{"label":"Push Scripts","command":"medable-dev-tools:push"},{"type":"separator"},{"label":"Settings...","command":"medable-dev-tools:showSettings"}]},
      menu = {};
